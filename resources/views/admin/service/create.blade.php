...
<div class="flex space-x-6">
    <div class="flex flex-col space-y-1 w-full">
        <label class="font-medium text-sm text-gray-600" for="name">{{ trans('maintenance.admin.service.name') }}</label>
    ...
    <div class="flex flex-col space-y-1 w-full">
        <label class="font-medium text-sm text-gray-600" for="description">{{ trans('maintenance.admin.service.description') }}</label>
        <input class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-300 focus:outline-none block w-full px-4 py-2.5" type="text" name="description" id="description"
            value="{{ isset($formData['model']) ? $formData['model']->description : null }}" required>
    </div>

</div>
<div class="flex space-x-6 mt-3">
    <div class="flex flex-col space-y-1 w-full">
        <label class="font-medium text-sm text-gray-600" for="price">{{ trans('maintenance.admin.service.price') }}</label>
    ...
    <div class="flex flex-col space-y-1 w-full">
        <label class="font-medium text-sm text-gray-600" for="branch_id">{{ trans('maintenance.admin.service.branch') }}</label>
