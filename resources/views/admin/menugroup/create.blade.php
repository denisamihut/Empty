...
<div class="flex space-x-6">
    <div class="flex flex-col space-y-1 w-full">
        <label class="font-medium text-sm text-gray-600" for="name">{{ trans('maintenance.admin.menugroup.name') }}</label>
...
<div class="flex space-x-6">
    <div class="flex flex-col space-y-1 w-full">
        <label class="font-medium text-sm text-gray-600" for="icon">{{ trans('maintenance.admin.menugroup.icon') }}</label>
    ...
    <div class="flex flex-col space-y-1 w-full">
        <label class="font-medium text-sm text-gray-600" for="order">{{ trans('maintenance.admin.menugroup.order') }}</label>
