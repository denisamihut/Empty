...
class MenuGroupController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->entity      = 'menu_groups';
        $this->folderview  = 'admin.menugroup';
        $this->adminTitle  = __('maintenance.admin.menugroup.title');
        ...
        $this->routes = [
            'search'  => 'menugroup.search',
            'index'   => 'menugroup.index',
            'store'   => 'menugroup.store',
            'delete'  => 'menugroup.delete',
            'create'  => 'menugroup.create',
            'edit'    => 'menugroup.edit',
            'update'  => 'menugroup.update',
            'destroy' => 'menugroup.destroy',
        ];
